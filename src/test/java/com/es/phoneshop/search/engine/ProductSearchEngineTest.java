...
public class ProductSearchEngineTest {
    ...
    public void setup() {
        ...
        products.add(new Product("xperiaz", "Sony Xperia XZ", new BigDecimal(120), usd, 100, "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Sony/Sony%20Xperia%20XZ.jpg"));
        ...
        products.add(new Product("smc56", "Siemens C56", new BigDecimal(70), usd, 20, "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Siemens/Siemens%20C56.jpg"));
        ...
        searchEngine = new ProductSearchEngine(products);
    }
    ...
    public void shouldFindProductsAscByPrice() {
        ...
        List<BigDecimal> expected = products
                .stream()
